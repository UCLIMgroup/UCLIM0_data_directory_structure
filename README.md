...
The repository has one Jypyter Notebook to guide the workflow.

- **Notebook 00_NewProject** - Define and create the new project directory to save and process data. 


Once you have created the project folder structure, copy the file "config_project.py" to your "local_directory_folder/projectname/" folder. 
